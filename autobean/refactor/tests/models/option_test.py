...
class TestOption(base.BaseTestModel):
    ...
    def test_parse_success(self, text: str, key: str, value: str) -> None:
        option = self._parser.parse(text, raw_models.Option)
    ...
    def test_parse_failure(self, text: str) -> None:
        with pytest.raises(exceptions.UnexpectedInput):
            self._parser.parse(text, raw_models.Option)
    ...
    def test_set_key(self) -> None:
        option = self._parser.parse('option  "key"    "value"', easy_models.Option)
