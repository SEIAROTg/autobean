...
class Price(internal.SurroundingCommentsMixin, base.RawTreeModel, internal.SpacingAccessorsMixin):
    ...
    def clone(self: _Self, token_store: base.TokenStore, token_transformer: base.TokenTransformer) -> _Self:
        return type(self)(
            ...
            type(self)._amount.clone(self._amount, token_store, token_transformer),
    ...
    def _reattach(self, token_store: base.TokenStore, token_transformer: base.TokenTransformer) -> None:
        ...
        self._amount = type(self)._amount.reattach(self._amount, token_store, token_transformer)
    ...
    def from_children(
        ...
        cls._amount.reattach(amount, token_store)
        ...
        return cls(token_store, leading_comment, date, label, currency, amount, inline_comment, eol, repeated_meta, dedent_mark, trailing_comment)
    ...
    def auto_claim_comments(self) -> None:
        ...
        type(self)._amount.auto_claim_comments(self._amount)
