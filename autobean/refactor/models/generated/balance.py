...
class Balance(internal.SurroundingCommentsMixin, base.RawTreeModel, internal.SpacingAccessorsMixin):
    ...
    def from_children(
        ...
        return cls(token_store, maybe_leading_comment, date, label, account, number, maybe_tolerance, currency, maybe_inline_comment, eol, repeated_meta, maybe_trailing_comment)
