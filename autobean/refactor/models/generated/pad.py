...
class Pad(internal.SurroundingCommentsMixin, base.RawTreeModel, internal.SpacingAccessorsMixin):
    ...
    def clone(self: _Self, token_store: base.TokenStore, token_transformer: base.TokenTransformer) -> _Self:
        return type(self)(
            ...
            type(self)._source_account.clone(self._source_account, token_store, token_transformer),
    ...
    def _reattach(self, token_store: base.TokenStore, token_transformer: base.TokenTransformer) -> None:
        ...
        self._source_account = type(self)._source_account.reattach(self._source_account, token_store, token_transformer)
    ...
    def from_children(
        ...
        cls._source_account.reattach(source_account, token_store)
        ...
        return cls(token_store, leading_comment, date, label, account, source_account, inline_comment, eol, repeated_meta, dedent_mark, trailing_comment)
    ...
    def auto_claim_comments(self) -> None:
        ...
        type(self)._source_account.auto_claim_comments(self._source_account)
