...
class SurroundingCommentsMixin(base.RawTreeModel):
    ...
    def claim_leading_comment(self) -> Optional[BlockComment]:
        return _claim_comment(self._leading_comment, self.first_token, self.token_store.get_prev)

    def unclaim_leading_comment(self) -> Optional[BlockComment]:
        return _unclaim_comment(self._leading_comment)

    def claim_trailing_comment(self) -> Optional[BlockComment]:
        return _claim_comment(self._trailing_comment, self.last_token, self.token_store.get_next)
